...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, PermissionConfig.ACCESS_COARSE_LOCATION) == 0 ? getLastKnownLocationForProvider("network") : null;
