...
public class LinkGenerator {
    ...
    private StringBuilder AFKeystoreWrapper() {
        ...
        if (this.onInstallConversionDataLoadedNative != null) {
            ...
            sb2.append(this.onInstallConversionDataLoadedNative.endsWith(CookieSpec.PATH_DELIM) ? "" : CookieSpec.PATH_DELIM);
            ...
            if (this.AFLogger$LogLevel != null) {
                sb.append(this.onInstallConversionDataLoadedNative.endsWith(CookieSpec.PATH_DELIM) ? "" : "%2F");
