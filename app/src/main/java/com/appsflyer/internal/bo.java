            ...
            try {
                ...
                build.startConnection(new InstallReferrerStateListener() { // from class: com.appsflyer.internal.bo.5
                    ...
                    public final void onInstallReferrerSetupFinished(int i) {
                        bo.this.AFInAppEventType.put(ResponseTypeValues.CODE, String.valueOf(i));
                        ...
                        if (i == -1) {
                            ...
                            try {
                                ...
                                if (build.isReady()) {
                                    ...
                                    bo.this.AFInAppEventType.put(EventUpdate.btn_install, Long.toString(installBeginTimestampSeconds));
