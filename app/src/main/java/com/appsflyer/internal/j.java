        ...
        if (AFInAppEventParameterName(uri.toString())) {
            ...
            kVar.AFInAppEventParameterName.execute(new Runnable() { // from class: com.appsflyer.internal.j.1
                ...
                public final void run() {
                    ...
                    int i = 0;
                    while (i < 5) {
                        Map<String, Object> AFInAppEventType2 = AFInAppEventType(Uri.parse(str2));
                        String str3 = (String) AFInAppEventType2.get("res");
                        Integer num2 = (Integer) AFInAppEventType2.get("status");
                        String str4 = (String) AFInAppEventType2.get("error");
                    ...
                    ae.values().AFInAppEventParameterName(context, map, str2 != null ? Uri.parse(str2) : uri);
                    j.valueOf = false;
                }
