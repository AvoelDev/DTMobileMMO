...
public final class aq extends bf {
    ...
    */
    ...
    private Map<String, Object> AFInAppEventParameterName(final d.e.C0015d c0015d) {
        Boolean bool;
        boolean z = false;
        if (c0015d != null && c0015d.values != null && ((bool = c0015d.valueOf) == null || !bool.booleanValue())) {
            z = true;
        }
        if (z) {
            return new HashMap<String, Object>() { // from class: com.appsflyer.internal.aq.5
                {
                    put(ShareConstants.MEDIA_TYPE, "unhashed");
                    put("value", d.e.C0015d.this.values);
                }
            };
        }
        return null;
