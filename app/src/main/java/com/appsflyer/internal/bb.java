...
public final class bb extends bf {
    ...
    */
    ...
    public void AFInAppEventType(String str) {
        ...
        d.e.C0015d AFInAppEventParameterName = ab.AFInAppEventParameterName(application.getContentResolver());
        ...
        this.AFInAppEventType.put(RealNameConstant.PARAM_PLAYER_UID, an.AFKeystoreWrapper(new WeakReference(application)));
