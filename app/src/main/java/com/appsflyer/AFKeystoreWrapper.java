...
public class AFKeystoreWrapper {
    ...
    public AFKeystoreWrapper(Context context) {
        ...
        try {
            this.AFInAppEventParameterName = KeyStore.getInstance("AndroidKeyStore");
            this.AFInAppEventParameterName.load(null);
        ...
        try {
            ...
            synchronized (this.values) {
                if (!this.AFInAppEventParameterName.containsAlias(str)) {
                    ...
                    KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(RSAUtils.RAS, "AndroidKeyStore");
