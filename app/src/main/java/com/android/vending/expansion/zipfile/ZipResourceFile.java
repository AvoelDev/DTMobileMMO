...
public class ZipResourceFile {
    ...
    public static final class ZipEntryRO {
        ...
        public void setOffsetFromFile(RandomAccessFile f, ByteBuffer buf) throws IOException {
            ...
            try {
                ...
                int extraLen = buf.getShort(28) & UShort.MAX_VALUE;
        ...
        public AssetFileDescriptor getAssetFileDescriptor() {
            if (this.mMethod == 0) {
                try {
                    ParcelFileDescriptor pfd = ParcelFileDescriptor.open(this.mFile, DriveFile.MODE_READ_ONLY);
    ...
    public void addPatchFile(String zipFileName) throws IOException {
        ...
        if (header == kEOCDSignature) {
            ...
            long dirSize = bbuf.getInt(eocdIdx + 12) & 4294967295L;
            long dirOffset = bbuf.getInt(eocdIdx + 16) & 4294967295L;
