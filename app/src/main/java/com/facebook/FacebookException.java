...
public class FacebookException extends RuntimeException {
    ...
    public FacebookException(final String str) {
        ...
        if (str != null) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.ErrorReport, new FeatureManager.Callback() { // from class: com.facebook.-$$Lambda$FacebookException$Lwu8uc2wlsUVYVAVO4fasaTYiyg
                @Override // com.facebook.internal.FeatureManager.Callback
                public final void onCompleted(boolean z) {
                    FacebookException.m16_init_$lambda0(str, z);
                }
            });
        }
    }
    ...
    public static final void m16_init_$lambda0(String str, boolean z) {
        if (z) {
            try {
