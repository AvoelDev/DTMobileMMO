...
public final class DialogPresenter {
    ...
    public static /* synthetic */ void lambda$fhIzQyl3hyZqHLod9SM9_VbxlBs(CallbackManager callbackManager, int i, Ref.ObjectRef objectRef, Pair pair) {
        m121startActivityForResultWithAndroidX$lambda2(callbackManager, i, objectRef, pair);
    }
    ...
    public static final void setupAppCallForCannotShowError(AppCall appCall) {
        ...
        DialogPresenter dialogPresenter = INSTANCE;
        setupAppCallForValidationError(appCall, facebookException);
    }
    ...
    public static final void startActivityForResultWithAndroidX(ActivityResultRegistry registry, final CallbackManager callbackManager, Intent intent, final int i) {
        ...
        }, new ActivityResultCallback() { // from class: com.facebook.internal.-$$Lambda$DialogPresenter$fhIzQyl3hyZqHLod9SM9_VbxlBs
            @Override // androidx.activity.result.ActivityResultCallback
            public final void onActivityResult(Object obj) {
                DialogPresenter.lambda$fhIzQyl3hyZqHLod9SM9_VbxlBs(CallbackManager.this, i, objectRef, (Pair) obj);
            }
        });
    ...
    public static final void m121startActivityForResultWithAndroidX$lambda2(CallbackManager callbackManager, int i, Ref.ObjectRef launcher, Pair pair) {
