...
public final class WorkQueue {
    ...
    public static /* synthetic */ void lambda$YRUquzszYma76Uhi8EXDq1RpaFo(WorkNode workNode, WorkQueue workQueue) {
        m153execute$lambda2(workNode, workQueue);
    }
    ...
    */
    ...
    public static final class Companion {
        ...
        /* renamed from: assert */
        public final void m154assert(boolean z) {
            if (!z) {
    ...
    public final void validate() {
        ...
        try {
            ...
            i = 0;
            Companion.m154assert(this.runningCount == i);
            Unit unit = Unit.INSTANCE;
        } finally {
            reentrantLock.unlock();
        }
    ...
    private final void execute(final WorkNode workNode) {
        this.executor.execute(new Runnable() { // from class: com.facebook.internal.-$$Lambda$WorkQueue$YRUquzszYma76Uhi8EXDq1RpaFo
            @Override // java.lang.Runnable
            public final void run() {
                WorkQueue.lambda$YRUquzszYma76Uhi8EXDq1RpaFo(WorkQueue.WorkNode.this, this);
            }
        });
    }

    /* renamed from: execute$lambda-2 */
    public static final void m153execute$lambda2(WorkNode node, WorkQueue this$0) {
    ...
    public final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode workNode, boolean z) {
            WorkQueue.Companion.m154assert(this.next == null);
            WorkQueue.Companion.m154assert(this.prev == null);
            if (workNode == null) {
                this.prev = this;
                this.next = this.prev;
                workNode = this.next;
