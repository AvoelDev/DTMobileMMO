...
public final class FacebookWebFallbackDialog extends WebDialog {
    ...
    public static /* synthetic */ void lambda$39JumiCzyrP8G3hoOow28ywSlHE(FacebookWebFallbackDialog facebookWebFallbackDialog) {
        m125cancel$lambda0(facebookWebFallbackDialog);
    }
    ...
    public void cancel() {
        ...
        if (!isPageFinished() || isListenerCalled() || webView == null || !webView.isShown()) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.internal.-$$Lambda$FacebookWebFallbackDialog$39JumiCzyrP8G3hoOow28ywSlHE
                @Override // java.lang.Runnable
                public final void run() {
                    FacebookWebFallbackDialog.lambda$39JumiCzyrP8G3hoOow28ywSlHE(FacebookWebFallbackDialog.this);
                }
            }, 1500L);
        }
    }
    ...
    public static final void m125cancel$lambda0(FacebookWebFallbackDialog this$0) {
