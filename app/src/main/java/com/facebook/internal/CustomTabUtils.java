...
public final class CustomTabUtils {
    ...
    public static final String getValidRedirectURI(String developerDefinedRedirectURI) {
        ...
        CustomTabUtils customTabUtils = INSTANCE;
        if (Validate.hasCustomTabRedirectActivity(applicationContext, getDefaultRedirectURI())) {
            CustomTabUtils customTabUtils2 = INSTANCE;
