...
public final class ServerProtocol {
    ...
    public static final String getGamingDialogAuthority() {
        ...
        ServerProtocol serverProtocol = INSTANCE;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        Object[] objArr = {FacebookSdk.getFacebookGamingDomain()};
        String format = String.format(GAMING_DIALOG_AUTHORITY_FORMAT, Arrays.copyOf(objArr, objArr.length));
        Intrinsics.checkNotNullExpressionValue(format, "java.lang.String.format(format, *args)");
        return format;
    }
    ...
    public static final Bundle getQueryParamsForPlatformActivityIntentWebFallback(String callId, int i, Bundle bundle) {
        ...
        ServerProtocol serverProtocol2 = INSTANCE;
        FacebookSdk facebookSdk3 = FacebookSdk.INSTANCE;
        bundle2.putString("app_id", FacebookSdk.getApplicationId());
        ServerProtocol serverProtocol3 = INSTANCE;
        bundle2.putInt("version", i);
        ServerProtocol serverProtocol4 = INSTANCE;
        ...
        try {
            ...
            if (convertToJSON != null && convertToJSON2 != null) {
                ServerProtocol serverProtocol5 = INSTANCE;
                bundle2.putString(FALLBACK_DIALOG_PARAM_BRIDGE_ARGS, convertToJSON.toString());
                ServerProtocol serverProtocol6 = INSTANCE;
