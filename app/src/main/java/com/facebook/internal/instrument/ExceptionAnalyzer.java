...
public final class ExceptionAnalyzer {
    ...
    public static final void execute(Throwable th) {
        if (enabled) {
            ExceptionAnalyzer exceptionAnalyzer = INSTANCE;
            if (isDebug$facebook_core_release() || th == null) {
                return;
            }
        ...
        while (i < length) {
            ...
            if (load.isValid()) {
                ...
                try {
                    ...
                    arrayList.add(companion.newPostRequest(null, format, jSONObject, new GraphRequest.Callback() { // from class: com.facebook.internal.instrument.-$$Lambda$ExceptionAnalyzer$1Cuw-G5Ok-mUMq61isq2E14FpEo
                        @Override // com.facebook.GraphRequest.Callback
                        public final void onCompleted(GraphResponse graphResponse) {
                            ExceptionAnalyzer.m156sendExceptionAnalysisReports$lambda1(InstrumentData.this, graphResponse);
                        }
                    }));
    ...
    public static final void m156sendExceptionAnalysisReports$lambda1(InstrumentData instrumentData, GraphResponse response) {
