...
public final class InstrumentData {
    ...
    private InstrumentData(File file) {
        ...
        this.filename = name;
        this.type = Companion.getType(this.filename);
        InstrumentUtility instrumentUtility = InstrumentUtility.INSTANCE;
