...
public final class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static final class Companion {
        ...
        private final void sendExceptionReports() {
            ...
            final List sortedWith = CollectionsKt.sortedWith(arrayList2, $$Lambda$CrashHandler$Companion$dchJtVPub_SzQZRVrsweQL2bN8k.INSTANCE);
            ...
            InstrumentUtility.sendReports("crash_reports", jSONArray, new GraphRequest.Callback() { // from class: com.facebook.internal.instrument.crashreport.-$$Lambda$CrashHandler$Companion$s_wAaaHVVnLQmp8otfUi4RXJp5o
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    CrashHandler.Companion.m170sendExceptionReports$lambda5(sortedWith, graphResponse);
                }
            });
        }
        ...
        public static final int m169sendExceptionReports$lambda2(InstrumentData instrumentData, InstrumentData o2) {
        ...
        public static final void m170sendExceptionReports$lambda5(List validReports, GraphResponse response) {
