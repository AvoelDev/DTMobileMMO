...
public final class FacebookDialogFragment extends DialogFragment {
    ...
    /* renamed from: lambda$3BbV3rJ4-THTu8bLGxrqhyLdAgU */
    public static /* synthetic */ void m124lambda$3BbV3rJ4THTu8bLGxrqhyLdAgU(FacebookDialogFragment facebookDialogFragment, Bundle bundle, FacebookException facebookException) {
        m122initDialog$lambda0(facebookDialogFragment, bundle, facebookException);
    }

    public static /* synthetic */ void lambda$WBlQjPDIShjArX4e5coy79ZG5ss(FacebookDialogFragment facebookDialogFragment, Bundle bundle, FacebookException facebookException) {
        m123initDialog$lambda1(facebookDialogFragment, bundle, facebookException);
    }
    ...
    public final void initDialog$facebook_common_release() {
        ...
        if (this.innerDialog == null && (activity = getActivity()) != null) {
            ...
            if (!(methodArgumentsFromIntent == null ? false : methodArgumentsFromIntent.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false))) {
                ...
                newInstance = new WebDialog.Builder(fragmentActivity, string, bundle).setOnCompleteListener(new WebDialog.OnCompleteListener() { // from class: com.facebook.internal.-$$Lambda$FacebookDialogFragment$3BbV3rJ4-THTu8bLGxrqhyLdAgU
                    @Override // com.facebook.internal.WebDialog.OnCompleteListener
                    public final void onComplete(Bundle bundle2, FacebookException facebookException) {
                        FacebookDialogFragment.m124lambda$3BbV3rJ4THTu8bLGxrqhyLdAgU(FacebookDialogFragment.this, bundle2, facebookException);
                    }
                }).build();
            } else {
                ...
                newInstance.setOnCompleteListener(new WebDialog.OnCompleteListener() { // from class: com.facebook.internal.-$$Lambda$FacebookDialogFragment$WBlQjPDIShjArX4e5coy79ZG5ss
                    @Override // com.facebook.internal.WebDialog.OnCompleteListener
                    public final void onComplete(Bundle bundle2, FacebookException facebookException) {
                        FacebookDialogFragment.lambda$WBlQjPDIShjArX4e5coy79ZG5ss(FacebookDialogFragment.this, bundle2, facebookException);
                    }
                });
            }
    ...
    public static final void m122initDialog$lambda0(FacebookDialogFragment this$0, Bundle bundle, FacebookException facebookException) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onCompleteWebDialog(bundle, facebookException);
    }

    /* renamed from: initDialog$lambda-1 */
    public static final void m123initDialog$lambda1(FacebookDialogFragment this$0, Bundle bundle, FacebookException facebookException) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
