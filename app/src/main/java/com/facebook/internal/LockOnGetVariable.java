...
public final class LockOnGetVariable<T> {
    ...
    /* renamed from: lambda$1_j9yNkVnknYIF5VP0kY-qc597k */
    public static /* synthetic */ Void m143lambda$1_j9yNkVnknYIF5VP0kYqc597k(LockOnGetVariable lockOnGetVariable, Callable callable) {
        return m142_init_$lambda0(lockOnGetVariable, callable);
    }
    ...
    public LockOnGetVariable(final Callable<T> callable) {
        ...
        FacebookSdk.getExecutor().execute(new FutureTask(new Callable() { // from class: com.facebook.internal.-$$Lambda$LockOnGetVariable$1_j9yNkVnknYIF5VP0kY-qc597k
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return LockOnGetVariable.m143lambda$1_j9yNkVnknYIF5VP0kYqc597k(LockOnGetVariable.this, callable);
            }
        }));
    }

    /* renamed from: _init_$lambda-0 */
    public static final Void m142_init_$lambda0(LockOnGetVariable this$0, Callable callable) {
