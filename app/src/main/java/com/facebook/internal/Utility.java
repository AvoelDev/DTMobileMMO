...
public final class Utility {
                    ...
                    if (array2 != null) {
                        ...
                        try {
                            if (strArr2.length == 2) {
                                ...
                                bundle.putString(decode, URLDecoder.decode(str4, "UTF-8"));
                            } else if (strArr2.length == 1) {
                                String str5 = strArr2[0];
                                Utility utility4 = INSTANCE;
                                bundle.putString(URLDecoder.decode(str5, "UTF-8"), "");
                            }
                        } catch (UnsupportedEncodingException e) {
                            Utility utility5 = INSTANCE;
                            logd(LOG_TAG, e);
                        }
                    } else {
    ...
    public static final void getGraphMeRequestWithCacheAsync(final String accessToken, final GraphMeRequestWithCacheCallback callback) {
        ...
        GraphRequest.Callback callback2 = new GraphRequest.Callback() { // from class: com.facebook.internal.-$$Lambda$Utility$SiJuQsWBfR6TkJ4AVljhxBXsqfM
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                Utility.m145getGraphMeRequestWithCacheAsync$lambda3(Utility.GraphMeRequestWithCacheCallback.this, accessToken, graphResponse);
            }
        };
    ...
    public static final void m145getGraphMeRequestWithCacheAsync$lambda3(GraphMeRequestWithCacheCallback callback, String accessToken, GraphResponse response) {
        Intrinsics.checkNotNullParameter(callback, "$callback");
        Intrinsics.checkNotNullParameter(accessToken, "$accessToken");
    ...
    private final int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] listFiles = new File("/sys/devices/system/cpu/").listFiles($$Lambda$Utility$QswqMT9ZjfJX3LanaBVHKaSSJ4I.INSTANCE);
            if (listFiles != null) {
    ...
    public static final boolean m146refreshBestGuessNumberOfCPUCores$lambda4(File file, String str) {
