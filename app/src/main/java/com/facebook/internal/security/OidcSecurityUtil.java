...
public final class OidcSecurityUtil {
    ...
    public static /* synthetic */ void lambda$1HTM35dyOhHNZ_OIQoY2VU90i3g(URL url, Ref.ObjectRef objectRef, String str, ReentrantLock reentrantLock, Condition condition) {
        m175getRawKeyFromEndPoint$lambda1(url, objectRef, str, reentrantLock, condition);
    }
    ...
    public static final String getRawKeyFromEndPoint(final String kid) {
        ...
        String stringPlus = Intrinsics.stringPlus("www.", FacebookSdk.getFacebookDomain());
        OidcSecurityUtil oidcSecurityUtil = INSTANCE;
        final URL url = new URL("https", stringPlus, OPENID_KEYS_PATH);
        final ReentrantLock reentrantLock = new ReentrantLock();
        final Condition newCondition = reentrantLock.newCondition();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        FacebookSdk facebookSdk2 = FacebookSdk.INSTANCE;
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.internal.security.-$$Lambda$OidcSecurityUtil$1HTM35dyOhHNZ_OIQoY2VU90i3g
            @Override // java.lang.Runnable
            public final void run() {
                OidcSecurityUtil.lambda$1HTM35dyOhHNZ_OIQoY2VU90i3g(url, objectRef, kid, reentrantLock, newCondition);
            }
        });
    ...
    public static final void m175getRawKeyFromEndPoint$lambda1(URL openIdKeyUrl, Ref.ObjectRef result, String kid, ReentrantLock lock, Condition condition) {
    ...
    public static final PublicKey getPublicKeyFromString(String key) {
        ...
        PublicKey generatePublic = KeyFactory.getInstance(RSAUtils.RAS).generatePublic(new X509EncodedKeySpec(decode));
