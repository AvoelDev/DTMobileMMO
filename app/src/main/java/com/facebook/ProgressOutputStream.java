...
public final class ProgressOutputStream extends FilterOutputStream implements RequestOutputStream {
    ...
    public static /* synthetic */ void lambda$lx65M8tX4srmQOXuzSnUOFogMmo(GraphRequestBatch.Callback callback, ProgressOutputStream progressOutputStream) {
        m36reportBatchProgress$lambda0(callback, progressOutputStream);
    }
        ...
        if (this.batchProgress > this.lastReportedProgress) {
            for (final GraphRequestBatch.Callback callback : this.requests.getCallbacks()) {
                if (callback instanceof GraphRequestBatch.OnProgressCallback) {
                    ...
                    if ((callbackHandler == null ? null : Boolean.valueOf(callbackHandler.post(new Runnable() { // from class: com.facebook.-$$Lambda$ProgressOutputStream$lx65M8tX4srmQOXuzSnUOFogMmo
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProgressOutputStream.lambda$lx65M8tX4srmQOXuzSnUOFogMmo(GraphRequestBatch.Callback.this, this);
                        }
                    }))) == null) {
    ...
    public static final void m36reportBatchProgress$lambda0(GraphRequestBatch.Callback callback, ProgressOutputStream this$0) {
