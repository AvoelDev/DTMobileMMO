...
public final class DeviceRequestsHelper {
    ...
    public static final String getDeviceInfo(Map<String, String> map) {
        ...
        DeviceRequestsHelper deviceRequestsHelper2 = INSTANCE;
    ...
    private final boolean startAdvertisementServiceImpl(final String str) {
        ...
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        final String str2 = "fbsdk_" + Intrinsics.stringPlus("android-", StringsKt.replace$default(FacebookSdk.getSdkVersion(), '.', '|', false, 4, (Object) null)) + '_' + ((Object) str);
