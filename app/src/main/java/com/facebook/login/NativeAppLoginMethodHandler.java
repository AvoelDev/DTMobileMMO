...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
    ...
    /* renamed from: lambda$-4r281_oyefK-1ARw81zOtoc6JU */
    public static /* synthetic */ void m198lambda$4r281_oyefK1ARw81zOtoc6JU(NativeAppLoginMethodHandler nativeAppLoginMethodHandler, LoginClient.Request request, Bundle bundle) {
        m199processSuccessResponse$lambda0(nativeAppLoginMethodHandler, request, bundle);
    }
    ...
    private final void processSuccessResponse(final LoginClient.Request request, final Bundle bundle) {
        if (bundle.containsKey(ResponseTypeValues.CODE)) {
            Utility utility = Utility.INSTANCE;
            if (!Utility.isNullOrEmpty(bundle.getString(ResponseTypeValues.CODE))) {
                FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.-$$Lambda$NativeAppLoginMethodHandler$-4r281_oyefK-1ARw81zOtoc6JU
                    @Override // java.lang.Runnable
                    public final void run() {
                        NativeAppLoginMethodHandler.m198lambda$4r281_oyefK1ARw81zOtoc6JU(NativeAppLoginMethodHandler.this, request, bundle);
                    }
                });
                return;
            }
    ...
    public static final void m199processSuccessResponse$lambda0(NativeAppLoginMethodHandler this$0, LoginClient.Request request, Bundle extras) {
