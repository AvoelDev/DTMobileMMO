...
public class LoginManager {
    ...
    private static final Set<String> OTHER_PUBLISH_PERMISSIONS = Companion.getOtherPublishPermissions();
    ...
    public static /* synthetic */ void lambda$YAfqG9TYlTuNKmsTdlsbJs5o4QQ(String str, LoginLogger loginLogger, LoginStatusCallback loginStatusCallback, String str2, Bundle bundle) {
        m195retrieveLoginStatusImpl$lambda2(str, loginLogger, loginStatusCallback, str2, bundle);
    }

    /* renamed from: lambda$kMGR0qOOGjdHDrJWMJLQ-0YFR1Y */
    public static /* synthetic */ boolean m192lambda$kMGR0qOOGjdHDrJWMJLQ0YFR1Y(LoginManager loginManager, int i, Intent intent) {
        return m196startLogin$lambda1(loginManager, i, intent);
    }

    /* renamed from: lambda$rSg-cm1724FMmQymgngXvUm4h7Y */
    public static /* synthetic */ boolean m193lambda$rSgcm1724FMmQymgngXvUm4h7Y(LoginManager loginManager, FacebookCallback facebookCallback, int i, Intent intent) {
        return m194registerCallback$lambda0(loginManager, facebookCallback, i, intent);
    }
    ...
    public LoginManager() {
        ...
        if (FacebookSdk.hasCustomTabsPrefetching) {
            ...
            if (CustomTabUtils.getChromePackage() != null) {
                ...
                CustomTabsClient.bindCustomTabsService(FacebookSdk.getApplicationContext(), Browsers.Chrome.PACKAGE_NAME, customTabPrefetchHelper);
    ...
    public final void registerCallback(CallbackManager callbackManager, final FacebookCallback<LoginResult> facebookCallback) {
        ...
        ((CallbackManagerImpl) callbackManager).registerCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback() { // from class: com.facebook.login.-$$Lambda$LoginManager$rSg-cm1724FMmQymgngXvUm4h7Y
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i, Intent intent) {
                return LoginManager.m193lambda$rSgcm1724FMmQymgngXvUm4h7Y(LoginManager.this, facebookCallback, i, intent);
            }
        });
    }

    /* renamed from: registerCallback$lambda-0 */
    public static final boolean m194registerCallback$lambda0(LoginManager this$0, FacebookCallback facebookCallback, int i, Intent intent) {
    ...
    public boolean onActivityResult(int i, Intent intent, FacebookCallback<LoginResult> facebookCallback) {
        ...
        finishLogin(accessToken, authenticationToken, request, facebookException, z, facebookCallback);
        return true;
    }
    ...
    public final class FacebookLoginActivityResultContract extends ActivityResultContract<Collection<? extends String>, CallbackManager.ActivityResultParameters> {
        ...
        public /* synthetic */ FacebookLoginActivityResultContract(CallbackManager callbackManager, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this(r2, (i & 1) != 0 ? null : callbackManager, (i & 2) != 0 ? null : str);
            LoginManager.this = r2;
        }
    ...
    private final void startLogin(StartActivityDelegate startActivityDelegate, LoginClient.Request request) throws FacebookException {
        ...
        CallbackManagerImpl.Companion.registerStaticCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback() { // from class: com.facebook.login.-$$Lambda$LoginManager$kMGR0qOOGjdHDrJWMJLQ-0YFR1Y
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i, Intent intent) {
                return LoginManager.m192lambda$kMGR0qOOGjdHDrJWMJLQ0YFR1Y(LoginManager.this, i, intent);
            }
        });
    ...
    public static final boolean m196startLogin$lambda1(LoginManager this$0, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void retrieveLoginStatusImpl(Context context, final LoginStatusCallback loginStatusCallback, long j) {
        ...
        newInstance$facebook_common_release.setCompletedListener(new PlatformServiceClient.CompletedListener() { // from class: com.facebook.login.-$$Lambda$LoginManager$YAfqG9TYlTuNKmsTdlsbJs5o4QQ
            @Override // com.facebook.internal.PlatformServiceClient.CompletedListener
            public final void completed(Bundle bundle) {
                LoginManager.lambda$YAfqG9TYlTuNKmsTdlsbJs5o4QQ(uuid, loginLogger, loginStatusCallback, applicationId, bundle);
            }
        });
    ...
    public static final void m195retrieveLoginStatusImpl$lambda2(String loggerRef, LoginLogger logger, LoginStatusCallback responseCallback, String applicationId, Bundle bundle) {
    ...
    public static final class AndroidxActivityResultRegistryOwnerStartActivityDelegate implements StartActivityDelegate {
        ...
        public static /* synthetic */ void lambda$gNFNbeQRFv0PEHxgImJMBDoUk64(AndroidxActivityResultRegistryOwnerStartActivityDelegate androidxActivityResultRegistryOwnerStartActivityDelegate, LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, Pair pair) {
            m197startActivityForResult$lambda0(androidxActivityResultRegistryOwnerStartActivityDelegate, loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, pair);
        }
        ...
        public void startActivityForResult(Intent intent, int i) {
            ...
            }, new ActivityResultCallback() { // from class: com.facebook.login.-$$Lambda$LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$gNFNbeQRFv0PEHxgImJMBDoUk64
                @Override // androidx.activity.result.ActivityResultCallback
                public final void onActivityResult(Object obj) {
                    LoginManager.AndroidxActivityResultRegistryOwnerStartActivityDelegate.lambda$gNFNbeQRFv0PEHxgImJMBDoUk64(LoginManager.AndroidxActivityResultRegistryOwnerStartActivityDelegate.this, loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, (Pair) obj);
                }
            }));
        ...
        public static final void m197startActivityForResult$lambda0(AndroidxActivityResultRegistryOwnerStartActivityDelegate this$0, LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder launcherHolder, Pair pair) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
