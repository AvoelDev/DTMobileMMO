...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public static /* synthetic */ void lambda$7swjnsLEN3poAnp8jda0f_NPNhE(DeviceAuthDialog deviceAuthDialog, String str, Date date, Date date2, GraphResponse graphResponse) {
        m181onSuccess$lambda10(deviceAuthDialog, str, date, date2, graphResponse);
    }

    public static /* synthetic */ void lambda$OnP18HwNn0dPo8QIBZRwSG2hDy0(DeviceAuthDialog deviceAuthDialog, View view) {
        m178initializeContentView$lambda2(deviceAuthDialog, view);
    }

    /* renamed from: lambda$Qkt4SBKxD9_3N_PQkRXH-HIetkw */
    public static /* synthetic */ void m179lambda$Qkt4SBKxD9_3N_PQkRXHHIetkw(DeviceAuthDialog deviceAuthDialog, String str, PermissionsLists permissionsLists, String str2, Date date, Date date2, DialogInterface dialogInterface, int i) {
        m182presentConfirmation$lambda6(deviceAuthDialog, str, permissionsLists, str2, date, date2, dialogInterface, i);
    }

    public static /* synthetic */ void lambda$Vz_pk8le8kjqOS0McJLaUGoxg4g(DeviceAuthDialog deviceAuthDialog) {
        m184schedulePoll$lambda3(deviceAuthDialog);
    }

    /* renamed from: lambda$YVyzWAnozkOx7sk-XLBk4RJAb3A */
    public static /* synthetic */ void m180lambda$YVyzWAnozkOx7skXLBk4RJAb3A(DeviceAuthDialog deviceAuthDialog, DialogInterface dialogInterface, int i) {
        m183presentConfirmation$lambda8(deviceAuthDialog, dialogInterface, i);
    }

    public static /* synthetic */ void lambda$ttgtpOIZDflet_LC9H6BLhK4DCM(DeviceAuthDialog deviceAuthDialog, GraphResponse graphResponse) {
        m177_get_pollRequest_$lambda5(deviceAuthDialog, graphResponse);
    }

    public static /* synthetic */ void lambda$wUSNyJCoKTm2CC7lkk5C7ohQUms(DeviceAuthDialog deviceAuthDialog, GraphResponse graphResponse) {
        m185startLogin$lambda1(deviceAuthDialog, graphResponse);
    }
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        GraphRequest.Companion.newPostRequestWithBundle(null, DEVICE_LOGIN_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$wUSNyJCoKTm2CC7lkk5C7ohQUms
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.lambda$wUSNyJCoKTm2CC7lkk5C7ohQUms(DeviceAuthDialog.this, graphResponse);
            }
        }).executeAsync();
    }

    /* renamed from: startLogin$lambda-1 */
    public static final void m185startLogin$lambda1(DeviceAuthDialog this$0, GraphResponse response) {
    ...
    protected View initializeContentView(boolean z) {
        ...
        ((Button) findViewById3).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$OnP18HwNn0dPo8QIBZRwSG2hDy0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DeviceAuthDialog.lambda$OnP18HwNn0dPo8QIBZRwSG2hDy0(DeviceAuthDialog.this, view);
            }
        });
    ...
    public static final void m178initializeContentView$lambda2(DeviceAuthDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onCancel();
    }
    ...
    private final void schedulePoll() {
        ...
        if (valueOf != null) {
            this.scheduledPoll = DeviceAuthMethodHandler.Companion.getBackgroundExecutor().schedule(new Runnable() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$Vz_pk8le8kjqOS0McJLaUGoxg4g
                @Override // java.lang.Runnable
                public final void run() {
                    DeviceAuthDialog.lambda$Vz_pk8le8kjqOS0McJLaUGoxg4g(DeviceAuthDialog.this);
                }
    ...
    public static final void m184schedulePoll$lambda3(DeviceAuthDialog this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.poll();
    }
    ...
    private final GraphRequest getPollRequest() {
        Bundle bundle = new Bundle();
        RequestState requestState = this.currentRequestState;
        bundle.putString(ResponseTypeValues.CODE, requestState == null ? null : requestState.getRequestCode());
        bundle.putString("access_token", getApplicationAccessToken());
        return GraphRequest.Companion.newPostRequestWithBundle(null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$ttgtpOIZDflet_LC9H6BLhK4DCM
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.lambda$ttgtpOIZDflet_LC9H6BLhK4DCM(DeviceAuthDialog.this, graphResponse);
            }
        });
    }

    /* renamed from: _get_pollRequest_$lambda-5 */
    public static final void m177_get_pollRequest_$lambda5(DeviceAuthDialog this$0, GraphResponse response) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(response, "response");
    ...
    private final void presentConfirmation(final String str, final PermissionsLists permissionsLists, final String str2, String str3, final Date date, final Date date2) {
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(format, new DialogInterface.OnClickListener() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$Qkt4SBKxD9_3N_PQkRXH-HIetkw
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m179lambda$Qkt4SBKxD9_3N_PQkRXHHIetkw(DeviceAuthDialog.this, str, permissionsLists, str2, date, date2, dialogInterface, i);
            }
        }).setPositiveButton(string3, new DialogInterface.OnClickListener() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$YVyzWAnozkOx7sk-XLBk4RJAb3A
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m180lambda$YVyzWAnozkOx7skXLBk4RJAb3A(DeviceAuthDialog.this, dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    public static final void m182presentConfirmation$lambda6(DeviceAuthDialog this$0, String userId, PermissionsLists permissions, String accessToken, Date date, Date date2, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m183presentConfirmation$lambda8(DeviceAuthDialog this$0, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void onSuccess(final String str, long j, Long l) {
        ...
        GraphRequest newGraphPathRequest = GraphRequest.Companion.newGraphPathRequest(new AccessToken(str, FacebookSdk.getApplicationId(), "0", null, null, null, null, date2, null, date, null, 1024, null), "me", new GraphRequest.Callback() { // from class: com.facebook.login.-$$Lambda$DeviceAuthDialog$7swjnsLEN3poAnp8jda0f_NPNhE
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.lambda$7swjnsLEN3poAnp8jda0f_NPNhE(DeviceAuthDialog.this, str, date2, date, graphResponse);
            }
        });
    ...
    public static final void m181onSuccess$lambda10(DeviceAuthDialog this$0, String accessToken, Date date, Date date2, GraphResponse response) {
