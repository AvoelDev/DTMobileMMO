...
public final class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    /* renamed from: lambda$0nbY_VDDLzAm-aRymMcAzSLWtvA */
    public static /* synthetic */ void m186lambda$0nbY_VDDLzAmaRymMcAzSLWtvA(GetTokenLoginMethodHandler getTokenLoginMethodHandler, LoginClient.Request request, Bundle bundle) {
        m187tryAuthorize$lambda1(getTokenLoginMethodHandler, request, bundle);
    }
    ...
    public int tryAuthorize(final LoginClient.Request request) {
        ...
        this.getTokenClient = new GetTokenClient(fragmentActivity, request);
        GetTokenClient getTokenClient = this.getTokenClient;
        if (Intrinsics.areEqual((Object) (getTokenClient == null ? null : Boolean.valueOf(getTokenClient.start())), (Object) false)) {
            return 0;
        }
        getLoginClient().notifyBackgroundProcessingStart();
        PlatformServiceClient.CompletedListener completedListener = new PlatformServiceClient.CompletedListener() { // from class: com.facebook.login.-$$Lambda$GetTokenLoginMethodHandler$0nbY_VDDLzAm-aRymMcAzSLWtvA
            @Override // com.facebook.internal.PlatformServiceClient.CompletedListener
            public final void completed(Bundle bundle) {
                GetTokenLoginMethodHandler.m186lambda$0nbY_VDDLzAmaRymMcAzSLWtvA(GetTokenLoginMethodHandler.this, request, bundle);
            }
        };
    ...
    public static final void m187tryAuthorize$lambda1(GetTokenLoginMethodHandler this$0, LoginClient.Request request, Bundle bundle) {
