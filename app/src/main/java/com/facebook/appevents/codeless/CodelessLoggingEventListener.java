...
public final class CodelessLoggingEventListener {
    ...
    /* renamed from: lambda$rINhrSOa1THfNqmiq44lI9zV-Zc */
    public static /* synthetic */ void m69lambda$rINhrSOa1THfNqmiq44lI9zVZc(String str, Bundle bundle) {
        m70logEvent$lambda0(str, bundle);
    }
    ...
    public static final void logEvent$facebook_core_release(EventBinding mapping, View rootView, View hostView) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.-$$Lambda$CodelessLoggingEventListener$rINhrSOa1THfNqmiq44lI9zV-Zc
            @Override // java.lang.Runnable
            public final void run() {
                CodelessLoggingEventListener.m69lambda$rINhrSOa1THfNqmiq44lI9zVZc(eventName, parameters);
            }
        });
    }

    /* renamed from: logEvent$lambda-0 */
    public static final void m70logEvent$lambda0(String eventName, Bundle parameters) {
