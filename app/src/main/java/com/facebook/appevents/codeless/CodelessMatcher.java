...
public final class CodelessMatcher {
    ...
    public static /* synthetic */ void lambda$gKDPp_dlRUURkiw1F3Mt_5rtcko(CodelessMatcher codelessMatcher2) {
        m73startTracking$lambda1(codelessMatcher2);
    }
    ...
    private final void startTracking() {
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            ...
            this.uiThreadHandler.post(new Runnable() { // from class: com.facebook.appevents.codeless.-$$Lambda$CodelessMatcher$gKDPp_dlRUURkiw1F3Mt_5rtcko
                @Override // java.lang.Runnable
                public final void run() {
                    CodelessMatcher.lambda$gKDPp_dlRUURkiw1F3Mt_5rtcko(CodelessMatcher.this);
                }
            });
        }
    }
    ...
    public static final void m73startTracking$lambda1(CodelessMatcher this$0) {
    ...
    public static final class ViewMatcher implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Runnable {
        ...
        public void run() {
            ...
            this.eventBindings = EventBinding.Companion.parseArray(appSettingsWithoutQuery.getEventBindings());
