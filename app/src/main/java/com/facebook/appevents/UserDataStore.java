...
public final class UserDataStore {
    ...
    public static /* synthetic */ void lambda$YGk8YqZCkvzuWLKQBGS0eI7uZ0k(String str, String str2) {
        m61writeDataIntoCache$lambda0(str, str2);
    }

    public static /* synthetic */ void lambda$oJJA_3gFApirfDnwA1imeHMSxTE(Bundle bundle) {
        m60setUserDataAndHash$lambda1(bundle);
    }
    ...
    private final void writeDataIntoCache(final String str, final String str2) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.-$$Lambda$UserDataStore$YGk8YqZCkvzuWLKQBGS0eI7uZ0k
            @Override // java.lang.Runnable
            public final void run() {
                UserDataStore.lambda$YGk8YqZCkvzuWLKQBGS0eI7uZ0k(str, str2);
            }
        });
    }

    /* renamed from: writeDataIntoCache$lambda-0 */
    public static final void m61writeDataIntoCache$lambda0(String key, String value) {
    ...
    public static final void setUserDataAndHash(final Bundle bundle) {
        InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute(new Runnable() { // from class: com.facebook.appevents.-$$Lambda$UserDataStore$oJJA_3gFApirfDnwA1imeHMSxTE
            @Override // java.lang.Runnable
            public final void run() {
                UserDataStore.lambda$oJJA_3gFApirfDnwA1imeHMSxTE(bundle);
            }
        });
    }

    /* renamed from: setUserDataAndHash$lambda-1 */
    public static final void m60setUserDataAndHash$lambda1(Bundle bundle) {
        if (!initialized.get()) {
    ...
    public static final void setUserDataAndHash(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10) {
        ...
        if (str3 != null) {
            UserDataStore userDataStore3 = INSTANCE;
            bundle.putString(LAST_NAME, str3);
        }
        if (str4 != null) {
            UserDataStore userDataStore4 = INSTANCE;
            bundle.putString(PHONE, str4);
        }
        if (str5 != null) {
            UserDataStore userDataStore5 = INSTANCE;
            bundle.putString(DATE_OF_BIRTH, str5);
        }
        if (str6 != null) {
            UserDataStore userDataStore6 = INSTANCE;
            bundle.putString(GENDER, str6);
        }
        if (str7 != null) {
            UserDataStore userDataStore7 = INSTANCE;
            bundle.putString(CITY, str7);
        }
        if (str8 != null) {
            UserDataStore userDataStore8 = INSTANCE;
            bundle.putString(STATE, str8);
        }
        if (str9 != null) {
            UserDataStore userDataStore9 = INSTANCE;
            bundle.putString(ZIP, str9);
        }
        if (str10 != null) {
            UserDataStore userDataStore10 = INSTANCE;
            bundle.putString(COUNTRY, str10);
        }
        UserDataStore userDataStore11 = INSTANCE;
    ...
    public static final void m58clear$lambda2() {
        if (!initialized.get()) {
            Log.w(TAG, "initStore should have been called before calling setUserData");
            INSTANCE.initAndWait();
        }
    ...
    private final synchronized void initAndWait() {
        ...
        String string = sharedPreferences2.getString(USER_DATA_KEY, "");
        if (string == null) {
            string = "";
        }
        ...
        String string2 = sharedPreferences3.getString(INTERNAL_USER_DATA_KEY, "");
        if (string2 == null) {
            string2 = "";
        }
    ...
    public static final void setInternalUd(Map<String, String> ud) {
        ...
        UserDataStore userDataStore6 = INSTANCE;
        Utility utility2 = Utility.INSTANCE;
        userDataStore6.writeDataIntoCache(INTERNAL_USER_DATA_KEY, Utility.mapToJsonStr(internalHashedUserData));
    }
