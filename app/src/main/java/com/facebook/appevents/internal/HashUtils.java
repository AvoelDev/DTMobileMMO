                ...
                public Object invoke(Object obj2, Method method, Object[] objects) {
                    ...
                    try {
                        if (Intrinsics.areEqual(method.getName(), "onChecksumsReady") && objects.length == 1 && (objects[0] instanceof List)) {
                            for (Object obj3 : (List) objects[0]) {
                                if (obj3 != null) {
