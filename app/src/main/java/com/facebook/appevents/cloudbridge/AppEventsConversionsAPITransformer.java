...
public final class AppEventsConversionsAPITransformer {
    ...
    public static final ArrayList<Map<String, Object>> transformEvents$facebook_core_release(String appEvents) {
        ...
        try {
                        ...
                        if (section != null) {
                            ...
                            try {
                                ...
                                if (invoke == CustomEventField.EVENT_NAME && ((String) map.get(str2)) != null) {
                                    AppEventsConversionsAPITransformer appEventsConversionsAPITransformer2 = INSTANCE;
                                    Object obj2 = map.get(str2);
                                    if (obj2 == null) {
                                        throw new NullPointerException("null cannot be cast to non-null type kotlin.String");
                                    }
                                    linkedHashMap2.put(rawValue2, appEventsConversionsAPITransformer2.transformEventName((String) obj2));
                                } else if (invoke == CustomEventField.EVENT_TIME && ((Integer) map.get(str2)) != null) {
                                    AppEventsConversionsAPITransformer appEventsConversionsAPITransformer3 = INSTANCE;
            ...
            Logger.Companion companion = Logger.Companion;
            LoggingBehavior loggingBehavior = LoggingBehavior.APP_EVENTS;
            AppEventsConversionsAPITransformer appEventsConversionsAPITransformer4 = INSTANCE;
            companion.log(loggingBehavior, TAG, "\n transformEvents JSONException: \n%s\n%s", appEvents, e2);
            return null;
        }
    }
