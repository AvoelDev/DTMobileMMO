...
public final class InAppPurchaseBillingClientWrapper {
    ...
    /* renamed from: lambda$XsjqS19lPubL8hf27Vd_gTQ-6Sg */
    public static /* synthetic */ void m83lambda$XsjqS19lPubL8hf27Vd_gTQ6Sg(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
        m84queryPurchaseHistory$lambda0(inAppPurchaseBillingClientWrapper, runnable);
    }
    ...
    public final void queryPurchaseHistory(String skuType, final Runnable queryPurchaseHistoryRunnable) {
        ...
        queryPurchaseHistoryAsync(skuType, new Runnable() { // from class: com.facebook.appevents.iap.-$$Lambda$InAppPurchaseBillingClientWrapper$XsjqS19lPubL8hf27Vd_gTQ-6Sg
            @Override // java.lang.Runnable
            public final void run() {
                InAppPurchaseBillingClientWrapper.m83lambda$XsjqS19lPubL8hf27Vd_gTQ6Sg(InAppPurchaseBillingClientWrapper.this, queryPurchaseHistoryRunnable);
            }
        });
    }

    /* renamed from: queryPurchaseHistory$lambda-0 */
    public static final void m84queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper this$0, Runnable queryPurchaseHistoryRunnable) {
    ...
    public final class PurchaseHistoryResponseListenerWrapper implements InvocationHandler {
        ...
        private final void getPurchaseHistoryRecord(List<?> list) {
            for (Object obj : list) {
                try {
                    InAppPurchaseUtils inAppPurchaseUtils = InAppPurchaseUtils.INSTANCE;
                    Object invokeMethod = InAppPurchaseUtils.invokeMethod(this.this$0.purchaseHistoryRecordClazz, this.this$0.getOriginalJsonPurchaseHistoryMethod, obj, new Object[0]);
    ...
    public final class SkuDetailsResponseListenerWrapper implements InvocationHandler {
        ...
        public final void parseSkuDetails(List<?> skuDetailsObjectList) {
            ...
            for (Object obj : skuDetailsObjectList) {
                try {
                    InAppPurchaseUtils inAppPurchaseUtils = InAppPurchaseUtils.INSTANCE;
                    Object invokeMethod = InAppPurchaseUtils.invokeMethod(this.this$0.skuDetailsClazz, this.this$0.getOriginalJsonSkuMethod, obj, new Object[0]);
                    String str = invokeMethod instanceof String ? (String) invokeMethod : null;
                    if (str != null) {
                        JSONObject jSONObject = new JSONObject(str);
                        if (jSONObject.has(InAppPurchaseBillingClientWrapper.PRODUCT_ID)) {
