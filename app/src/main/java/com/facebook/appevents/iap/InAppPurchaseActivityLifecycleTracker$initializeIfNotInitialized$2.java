...
public final class InAppPurchaseActivityLifecycleTracker$initializeIfNotInitialized$2 implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityResumed(Activity activity) {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute($$Lambda$InAppPurchaseActivityLifecycleTracker$initializeIfNotInitialized$2$txKW7GZ_xQvVk15ewp7rPbvZVIE.INSTANCE);
    ...
    public static final void m78onActivityResumed$lambda0() {
        Object obj;
        Object obj2;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
    ...
    public void onActivityStopped(Activity activity) {
        ...
        try {
            ...
            if (Intrinsics.areEqual((Object) bool, (Object) true) && Intrinsics.areEqual(activity.getLocalClassName(), "com.android.billingclient.api.ProxyBillingActivity")) {
                FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
                FacebookSdk.getExecutor().execute($$Lambda$InAppPurchaseActivityLifecycleTracker$initializeIfNotInitialized$2$VOCg5vmp12MmgjbBZ82voq3Jbbk.INSTANCE);
            }
        } catch (Exception unused) {
        }
    }
    ...
    public static final void m79onActivityStopped$lambda1() {
        Object obj;
        Object obj2;
        FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        Context applicationContext = FacebookSdk.getApplicationContext();
