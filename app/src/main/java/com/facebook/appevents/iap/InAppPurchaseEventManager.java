...
public final class InAppPurchaseEventManager {
    ...
    private final boolean isBillingSupported(Context context, Object obj, String str) {
        Object invokeMethod;
        return (obj == null || (invokeMethod = invokeMethod(context, IN_APP_BILLING_SERVICE, IS_BILLING_SUPPORTED, obj, new Object[]{3, PACKAGE_NAME, str})) == null || ((Integer) invokeMethod).intValue() != 0) ? false : true;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:21:0x005d A[EDGE_INSN: B:21:0x005d->B:19:0x005d ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    private final java.util.ArrayList<java.lang.String> getPurchases(android.content.Context r13, java.lang.Object r14, java.lang.String r15) {
        ...
        L12:
            ...
            r11[r1] = r6
            r6 = 1
            java.lang.String r7 = com.facebook.appevents.iap.InAppPurchaseEventManager.PACKAGE_NAME
            r11[r6] = r7
            r6 = 2
            r11[r6] = r15
            r11[r5] = r3
    ...
    private final Method getMethod(Class<?> cls, String str) {
        ...
        if (declaredMethod$facebook_core_release != null) {
            methodMap.put(str, declaredMethod$facebook_core_release);
        }
    ...
    public static final void clearSkuDetailsCache() {
        ...
        if (j == 0) {
            SharedPreferences.Editor edit = skuDetailSharedPrefs.edit();
            InAppPurchaseEventManager inAppPurchaseEventManager2 = INSTANCE;
            edit.putLong(LAST_CLEARED_TIME, currentTimeMillis).apply();
            return;
        }
        InAppPurchaseEventManager inAppPurchaseEventManager3 = INSTANCE;
        if (currentTimeMillis - j > ((long) CACHE_CLEAR_TIME_LIMIT_SEC)) {
            SharedPreferences.Editor clear = skuDetailSharedPrefs.edit().clear();
            InAppPurchaseEventManager inAppPurchaseEventManager4 = INSTANCE;
