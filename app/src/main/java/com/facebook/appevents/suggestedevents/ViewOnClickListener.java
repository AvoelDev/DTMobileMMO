...
public final class ViewOnClickListener implements View.OnClickListener {
    ...
    public static /* synthetic */ void lambda$dZXHma1H2trVyKwRMP_LC2fyHII(JSONObject jSONObject, String str, ViewOnClickListener viewOnClickListener, String str2) {
        m100predictAndProcess$lambda0(jSONObject, str, viewOnClickListener, str2);
    }
    ...
    private final void predictAndProcess(final String str, final String str2, final JSONObject jSONObject) {
        ...
        Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.-$$Lambda$ViewOnClickListener$dZXHma1H2trVyKwRMP_LC2fyHII
            @Override // java.lang.Runnable
            public final void run() {
                ViewOnClickListener.lambda$dZXHma1H2trVyKwRMP_LC2fyHII(jSONObject, str2, this, str);
            }
        });
    }

    /* renamed from: predictAndProcess$lambda-0 */
    public static final void m100predictAndProcess$lambda0(JSONObject viewData, String buttonText, ViewOnClickListener this$0, String pathID) {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void lambda$dTlsUhSsPkCATwEV0pZphbyxXEk(String str, String str2) {
            m101queryHistoryAndProcess$lambda0(str, str2);
        }
        ...
        public final boolean queryHistoryAndProcess(String str, final String str2) {
            ...
            Utility utility = Utility.INSTANCE;
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.-$$Lambda$ViewOnClickListener$Companion$dTlsUhSsPkCATwEV0pZphbyxXEk
                @Override // java.lang.Runnable
                public final void run() {
                    ViewOnClickListener.Companion.lambda$dTlsUhSsPkCATwEV0pZphbyxXEk(queryEvent, str2);
                }
            });
            return true;
        }
        ...
        public static final void m101queryHistoryAndProcess$lambda0(String queriedEvent, String buttonText) {
        ...
        public final void processPredictedResult(String str, String str2, float[] fArr) {
            ...
            if (Intrinsics.checkNotNullParameter(str, "event")) {
                FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
        ...
        private final void sendPredictedResult(String str, String str2, float[] fArr) {
            ...
            try {
                ...
                String format = String.format(locale, ViewOnClickListener.API_ENDPOINT, Arrays.copyOf(objArr, objArr.length));
