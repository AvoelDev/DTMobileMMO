...
public final class ViewObserver implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static /* synthetic */ void lambda$nUCensw0nSAvmui3ddkjIj25lYc(ViewObserver viewObserver) {
        m99process$lambda0(viewObserver);
    }
    ...
    private final void process() {
        Runnable runnable = new Runnable() { // from class: com.facebook.appevents.suggestedevents.-$$Lambda$ViewObserver$nUCensw0nSAvmui3ddkjIj25lYc
            @Override // java.lang.Runnable
            public final void run() {
                ViewObserver.lambda$nUCensw0nSAvmui3ddkjIj25lYc(ViewObserver.this);
            }
        };
    ...
    public static final void m99process$lambda0(ViewObserver this$0) {
