...
public final class AuthenticationTokenClaims implements Parcelable {
    ...
    public int hashCode() {
        ...
        hashCode2 = Long.valueOf(this.iat).hashCode();
        int hashCode3 = (((((((((((((527 + this.jti.hashCode()) * 31) + this.iss.hashCode()) * 31) + this.aud.hashCode()) * 31) + this.nonce.hashCode()) * 31) + hashCode) * 31) + hashCode2) * 31) + this.sub.hashCode()) * 31;
    ...
    */
    ...
    public final JSONObject toJSONObject$facebook_core_release() {
        ...
        Set<String> set = this.userFriends;
        if (set != null) {
            jSONObject.put(JSON_KEY_USER_FRIENDS, new JSONArray((Collection) set));
        }
        ...
        Map<String, Integer> map = this.userAgeRange;
        if (map != null) {
            jSONObject.put(JSON_KEY_USER_AGE_RANGE, new JSONObject(map));
        }
        Map<String, String> map2 = this.userHometown;
        if (map2 != null) {
            jSONObject.put(JSON_KEY_USER_HOMETOWN, new JSONObject(map2));
        }
        Map<String, String> map3 = this.userLocation;
        if (map3 != null) {
            jSONObject.put(JSON_KEY_USER_LOCATION, new JSONObject(map3));
        }
