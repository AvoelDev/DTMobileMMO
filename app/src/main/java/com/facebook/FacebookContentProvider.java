...
public final class FacebookContentProvider extends ContentProvider {
    ...
    private final Pair<UUID, String> parseCallIdAndAttachmentName(Uri uri) {
        try {
            ...
            Object[] array = StringsKt.split$default((CharSequence) substring, new String[]{CookieSpec.PATH_DELIM}, false, 0, 6, (Object) null).toArray(new String[0]);
            if (array != null) {
    ...
    public static final class Companion {
        ...
        public final String getAttachmentUrl(String str, UUID callId, String str2) {
            ...
            Object[] objArr = {FacebookContentProvider.ATTACHMENT_URL_BASE, str, callId.toString(), str2};
