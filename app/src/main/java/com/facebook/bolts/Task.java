...
public final class Task<TResult> {
    ...
    public final Task<Void> makeVoid() {
        return continueWithTask($$Lambda$Task$ndlVPrub0oL9djdunBW8rP1h3c.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: makeVoid$lambda-8  reason: not valid java name */
    public static final Task m108makeVoid$lambda8(Task task) {
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWith(final Continuation<TResult, TContinuationResult> continuation, final Executor executor, final CancellationToken cancellationToken) {
        ...
        try {
            ...
            if (!isCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$DkUUPTyI3-l5fsyoW-2mBJErRXQ
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m103continueWith$lambda10$lambda9;
                        m103continueWith$lambda10$lambda9 = Task.m103continueWith$lambda10$lambda9(TaskCompletionSource.this, continuation, executor, cancellationToken, task);
                        return m103continueWith$lambda10$lambda9;
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final Void m103continueWith$lambda10$lambda9(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
    ...
    public final <TContinuationResult> Task<TContinuationResult> continueWithTask(final Continuation<TResult, Task<TContinuationResult>> continuation, final Executor executor, final CancellationToken cancellationToken) {
        ...
        try {
            boolean isCompleted = isCompleted();
            if (!isCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$GygBnnfOWZNYQ7JmBuk9HWZ8y5o
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m104continueWithTask$lambda12$lambda11;
                        m104continueWithTask$lambda12$lambda11 = Task.m104continueWithTask$lambda12$lambda11(TaskCompletionSource.this, continuation, executor, cancellationToken, task);
                        return m104continueWithTask$lambda12$lambda11;
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final Void m104continueWithTask$lambda12$lambda11(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(tcs, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccess(final Continuation<TResult, TContinuationResult> continuation, Executor executor, final CancellationToken cancellationToken) {
        Intrinsics.checkNotNullParameter(continuation, "continuation");
        Intrinsics.checkNotNullParameter(executor, "executor");
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$tD3cqPbPFfqtF3aCjXVkUkupd_4
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                Task m109onSuccess$lambda13;
                m109onSuccess$lambda13 = Task.m109onSuccess$lambda13(CancellationToken.this, continuation, task);
                return m109onSuccess$lambda13;
            }
        }, executor);
    }
    ...
    public static final Task m109onSuccess$lambda13(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccessTask(final Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, final CancellationToken cancellationToken) {
        Intrinsics.checkNotNullParameter(continuation, "continuation");
        Intrinsics.checkNotNullParameter(executor, "executor");
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$AEERQ5nJpdXTdK3r6d2a9-d3Dio
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                Task m110onSuccessTask$lambda14;
                m110onSuccessTask$lambda14 = Task.m110onSuccessTask$lambda14(CancellationToken.this, continuation, task);
                return m110onSuccessTask$lambda14;
            }
        }, executor);
    }
    ...
    public static final Task m110onSuccessTask$lambda14(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return Companion.cancelled();
    ...
    public static final class Companion {
        ...
        public final Task<Void> delay$facebook_bolts_release(long j, ScheduledExecutorService executor, CancellationToken cancellationToken) {
            ...
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                ...
                final com.facebook.bolts.TaskCompletionSource taskCompletionSource = new com.facebook.bolts.TaskCompletionSource();
                final ScheduledFuture<?> schedule = executor.schedule(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$00u4jcjSlQ_VRQ2wZOWQqGc3758
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m115delay$lambda0(TaskCompletionSource.this);
                    }
                }, j, TimeUnit.MILLISECONDS);
                if (cancellationToken != null) {
                    cancellationToken.register(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$8ym7XUvaePkWZh1Zzudh5cx9PvE
                        @Override // java.lang.Runnable
                        public final void run() {
                            Task.Companion.m116delay$lambda1(schedule, taskCompletionSource);
                        }
                    });
                }
                return taskCompletionSource.getTask();
        ...
        public static final void m115delay$lambda0(com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public static final void m116delay$lambda1(ScheduledFuture scheduledFuture, com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public final <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor, final CancellationToken cancellationToken) {
            ...
            final com.facebook.bolts.TaskCompletionSource taskCompletionSource = new com.facebook.bolts.TaskCompletionSource();
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$AeCcBSYQChNssSCldGsPu-jFsjk
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m111call$lambda2(CancellationToken.this, taskCompletionSource, callable);
                    }
                });
            } catch (Exception e) {
        ...
        public static final void m111call$lambda2(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Callable callable) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(callable, "$callable");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                tcs.setCancelled();
        ...
        public final <TResult> Task<Task<TResult>> whenAnyResult(Collection<Task<TResult>> tasks) {
            ...
            for (Task<TResult> task : tasks) {
                task.continueWith(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$OsjVLevBdzKKfZrFDqksUuzNGuk
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task2) {
                        Void m120whenAnyResult$lambda3;
                        m120whenAnyResult$lambda3 = Task.Companion.m120whenAnyResult$lambda3(atomicBoolean, taskCompletionSource, task2);
                        return m120whenAnyResult$lambda3;
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m120whenAnyResult$lambda3(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
        ...
        public final Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
            ...
            final AtomicBoolean atomicBoolean = new AtomicBoolean(false);
            for (Task<?> task : tasks) {
                task.continueWith(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$DTZMhz2-2kHqjlT227Lcdln1iQ8
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task2) {
                        Void m119whenAny$lambda4;
                        m119whenAny$lambda4 = Task.Companion.m119whenAny$lambda4(atomicBoolean, taskCompletionSource, task2);
                        return m119whenAny$lambda4;
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m119whenAny$lambda4(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
            Intrinsics.checkNotNullParameter(isAnyTaskComplete, "$isAnyTaskComplete");
            Intrinsics.checkNotNullParameter(firstCompleted, "$firstCompleted");
            Intrinsics.checkNotNullParameter(it, "it");
            if (isAnyTaskComplete.compareAndSet(false, true)) {
        ...
        public final <TContinuationResult, TResult> void completeImmediately(final com.facebook.bolts.TaskCompletionSource<TContinuationResult> taskCompletionSource, final Continuation<TResult, TContinuationResult> continuation, final Task<TResult> task, Executor executor, final CancellationToken cancellationToken) {
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$bwKIt3TqJbWhSNgNp4buU40cpzk
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m114completeImmediately$lambda5(CancellationToken.this, taskCompletionSource, continuation, task);
                    }
                });
            } catch (Exception e) {
                taskCompletionSource.setError(new ExecutorException(e));
        ...
        public static final void m114completeImmediately$lambda5(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
        ...
        public final <TContinuationResult, TResult> void completeAfterTask(final com.facebook.bolts.TaskCompletionSource<TContinuationResult> taskCompletionSource, final Continuation<TResult, Task<TContinuationResult>> continuation, final Task<TResult> task, Executor executor, final CancellationToken cancellationToken) {
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$J_dJ8HRMxYOftSl00oQS57pNUlI
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m112completeAfterTask$lambda7(CancellationToken.this, taskCompletionSource, continuation, task);
                    }
                });
            } catch (Exception e) {
                taskCompletionSource.setError(new ExecutorException(e));
        ...
        public static final void m112completeAfterTask$lambda7(final CancellationToken cancellationToken, final com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            ...
            try {
                ...
                if (task2 != null) {
                    task2.continueWith(new Continuation() { // from class: com.facebook.bolts.-$$Lambda$Task$Companion$SSLcYcTjemLSTpPxYM9vYdJE3kg
                        @Override // com.facebook.bolts.Continuation
                        public final Object then(Task task3) {
                            Void m113completeAfterTask$lambda7$lambda6;
                            m113completeAfterTask$lambda7$lambda6 = Task.Companion.m113completeAfterTask$lambda7$lambda6(CancellationToken.this, tcs, task3);
                            return m113completeAfterTask$lambda7$lambda6;
                        }
                    });
                } else {
                    tcs.setResult(null);
        ...
        public static final Void m113completeAfterTask$lambda7$lambda6(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(task, "task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                tcs.setCancelled();
