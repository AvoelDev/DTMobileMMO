...
public final class CancellationTokenSource implements Closeable {
    ...
    public static /* synthetic */ void lambda$B7ZdbOb9P5KpeZDB5Bc9P4dtpBM(CancellationTokenSource cancellationTokenSource) {
        m102cancelAfter$lambda6$lambda5(cancellationTokenSource);
    }
    ...
    private final void cancelAfter(long j, TimeUnit timeUnit) {
        ...
        synchronized (this.lock) {
            ...
            cancelScheduledCancellation();
            if (j != -1) {
                this.scheduledCancellation = this.executor.schedule(new Runnable() { // from class: com.facebook.bolts.-$$Lambda$CancellationTokenSource$B7ZdbOb9P5KpeZDB5Bc9P4dtpBM
                    @Override // java.lang.Runnable
                    public final void run() {
                        CancellationTokenSource.lambda$B7ZdbOb9P5KpeZDB5Bc9P4dtpBM(CancellationTokenSource.this);
                    }
                }, j, timeUnit);
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final void m102cancelAfter$lambda6$lambda5(CancellationTokenSource this$0) {
    ...
    public String toString() {
        ...
        Object[] objArr = {getClass().getName(), Integer.toHexString(hashCode()), Boolean.toString(isCancellationRequested())};
