...
public final class ShareInternalUtility {
    ...
    /* renamed from: lambda$c--pHWfagVGoXneMZgwWMxpNU8g */
    public static /* synthetic */ boolean m201lambda$cpHWfagVGoXneMZgwWMxpNU8g(int i, FacebookCallback facebookCallback, int i2, Intent intent) {
        return m202registerSharerCallback$lambda1(i, facebookCallback, i2, intent);
    }

    public static /* synthetic */ boolean lambda$epfjVcmMU6Vq6EJQfBCuB3rhU9s(int i, int i2, Intent intent) {
        return m203registerStaticShareCallback$lambda0(i, i2, intent);
    }
    ...
    public static final void invokeCallbackWithException(FacebookCallback<Sharer.Result> facebookCallback, Exception exception) {
        ...
        ShareInternalUtility shareInternalUtility2 = INSTANCE;
    ...
    public static final void registerStaticShareCallback(final int i) {
        CallbackManagerImpl.Companion.registerStaticCallback(i, new CallbackManagerImpl.Callback() { // from class: com.facebook.share.internal.-$$Lambda$ShareInternalUtility$epfjVcmMU6Vq6EJQfBCuB3rhU9s
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i2, Intent intent) {
                return ShareInternalUtility.lambda$epfjVcmMU6Vq6EJQfBCuB3rhU9s(i, i2, intent);
            }
        });
    }

    /* renamed from: registerStaticShareCallback$lambda-0 */
    public static final boolean m203registerStaticShareCallback$lambda0(int i, int i2, Intent intent) {
        ShareInternalUtility shareInternalUtility = INSTANCE;
    ...
    public static final void registerSharerCallback(final int i, CallbackManager callbackManager, final FacebookCallback<Sharer.Result> facebookCallback) {
        ...
        ((CallbackManagerImpl) callbackManager).registerCallback(i, new CallbackManagerImpl.Callback() { // from class: com.facebook.share.internal.-$$Lambda$ShareInternalUtility$c--pHWfagVGoXneMZgwWMxpNU8g
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i2, Intent intent) {
                return ShareInternalUtility.m201lambda$cpHWfagVGoXneMZgwWMxpNU8g(i, facebookCallback, i2, intent);
            }
        });
    }

    /* renamed from: registerSharerCallback$lambda-1 */
    public static final boolean m202registerSharerCallback$lambda1(int i, FacebookCallback facebookCallback, int i2, Intent intent) {
        ShareInternalUtility shareInternalUtility = INSTANCE;
        ...
        try {
            ...
            if (length > 0) {
                while (true) {
                    ...
                    ShareInternalUtility shareInternalUtility3 = INSTANCE;
