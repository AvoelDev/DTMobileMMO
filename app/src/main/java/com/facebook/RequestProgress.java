...
public final class RequestProgress {
    ...
    public final void reportProgress() {
        if (this.progress > this.lastReportedProgress) {
            ...
            if ((handler == null ? null : Boolean.valueOf(handler.post(new Runnable() { // from class: com.facebook.-$$Lambda$RequestProgress$mJ1BmTeY74bqiNqcd6VGSDp4lTs
                @Override // java.lang.Runnable
                public final void run() {
                    RequestProgress.m37reportProgress$lambda0(GraphRequest.Callback.this, j2, j);
                }
            }))) == null) {
    ...
    public static final void m37reportProgress$lambda0(GraphRequest.Callback callback, long j, long j2) {
