...
public final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = $$Lambda$ProtobufDataEncoderContext$GrnqT7BliQwjE8CB4RFyP3_ydXo.INSTANCE;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$encoders$proto$Protobuf$IntEncoding = new int[Protobuf.IntEncoding.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$encoders$proto$Protobuf$IntEncoding[Protobuf.IntEncoding.DEFAULT.ordinal()] = 1;
    ...
    private void writeVarInt32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.output.write((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | 128);
            i >>>= 7;
        }
        this.output.write(i & TransportMediator.KEYCODE_MEDIA_PAUSE);
    }

    private void writeVarInt64(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.output.write((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | 128);
            j >>>= 7;
        }
        this.output.write(((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE);
    }
}
