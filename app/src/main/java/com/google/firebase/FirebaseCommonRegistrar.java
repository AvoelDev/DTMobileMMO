...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, $$Lambda$FirebaseCommonRegistrar$MJj2GWKO_yLkSyf6AZfNviARrgQ.INSTANCE));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, $$Lambda$FirebaseCommonRegistrar$pGT1RcP4RapBpOq2V73IRqI1I.INSTANCE));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, $$Lambda$FirebaseCommonRegistrar$OMGxGzs72JnsFA__aYRvT3a3SZo.INSTANCE));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, $$Lambda$FirebaseCommonRegistrar$0SsttI_xA8sAI74ZXlgAQ_rvhA.INSTANCE));
