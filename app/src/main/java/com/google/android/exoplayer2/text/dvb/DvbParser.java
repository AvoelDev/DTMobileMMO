            ...
            if (i < 8) {
                ...
                switch (i & 136) {
                    case 0:
                        ...
                        continue;
                    case 8:
                        entries[i] = getColor(TransportMediator.KEYCODE_MEDIA_PAUSE, ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? 170 : 0), ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? 170 : 0), ((i & 64) != 0 ? 170 : 0) + ((i & 4) != 0 ? 85 : 0));
                        continue;
                    case 128:
                        entries[i] = getColor(255, ((i & 1) != 0 ? 43 : 0) + TransportMediator.KEYCODE_MEDIA_PAUSE + ((i & 16) != 0 ? 85 : 0), ((i & 2) != 0 ? 43 : 0) + TransportMediator.KEYCODE_MEDIA_PAUSE + ((i & 32) != 0 ? 85 : 0), ((i & 64) != 0 ? 85 : 0) + ((i & 4) != 0 ? 43 : 0) + TransportMediator.KEYCODE_MEDIA_PAUSE);
                        continue;
                    case 136:
