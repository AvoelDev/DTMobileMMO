...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    private void processOutputFormat() throws ExoPlaybackException {
        ...
        if (this.codecAdaptationWorkaroundMode != 0 && format.getInteger(ViewHierarchyConstants.DIMENSION_WIDTH_KEY) == 32 && format.getInteger(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY) == 32) {
