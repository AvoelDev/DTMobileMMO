...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int mode, byte[] secretKey, long nonce, long offset) {
        try {
            ...
            this.cipher.init(mode, new SecretKeySpec(secretKey, Util.splitAtFirst(this.cipher.getAlgorithm(), CookieSpec.PATH_DELIM)[0]), new IvParameterSpec(getInitializationVector(nonce, counter)));
            if (startPadding != 0) {
