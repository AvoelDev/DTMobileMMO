...
public final class ParsableByteArray {
    ...
    public int readInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        int i3 = (((bArr[i] & UByte.MAX_VALUE) << 24) >> 8) | ((bArr2[i2] & UByte.MAX_VALUE) << 8);
        byte[] bArr3 = this.data;
        int i4 = this.position;
        this.position = i4 + 1;
        return i3 | (bArr3[i4] & UByte.MAX_VALUE);
    ...
    public int readUnsignedFixedPoint1616() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        int result = ((bArr[i] & UByte.MAX_VALUE) << 8) | (bArr2[i2] & UByte.MAX_VALUE);
        this.position += 2;
        return result;
    }
    ...
    public String readNullTerminatedString(int length) {
        ...
        String fromUtf8Bytes = Util.fromUtf8Bytes(this.data, this.position, stringLength);
        this.position += length;
    ...
    public String readNullTerminatedString() {
        ...
        String fromUtf8Bytes = Util.fromUtf8Bytes(this.data, this.position, stringLimit - this.position);
    ...
    public String readLine() {
        ...
        String fromUtf8Bytes = Util.fromUtf8Bytes(this.data, this.position, lineLimit - this.position);
