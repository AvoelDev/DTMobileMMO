...
public final class zzv extends GoogleApi<Api.ApiOptions.NoOptions> implements SmsCodeBrowserClient {
    ...
    private static final Api.AbstractClientBuilder<zzw, Api.ApiOptions.NoOptions> zzb = new zzt();
    private static final Api<Api.ApiOptions.NoOptions> zzc = new Api<>("SmsCodeBrowser.API", zzb, zza);
