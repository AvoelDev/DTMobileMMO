...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        /* loaded from: classes2.dex */
        public static final class C0017zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C0017zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            static {
                ...
                zzao.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, FastJsonResponse.Field.forInteger(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, 4));
            }
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            public C0017zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
            ...
            @Override // com.google.android.gms.common.server.response.FastSafeParcelableJsonResponse
            public final boolean equals(Object obj) {
                if (obj instanceof C0017zzb) {
                    if (this == obj) {
                        return true;
                    }
                    C0017zzb c0017zzb = (C0017zzb) obj;
                    for (FastJsonResponse.Field<?, ?> field : zzao.values()) {
                        if (isFieldSet(field)) {
                            if (!c0017zzb.isFieldSet(field) || !getFieldValue(field).equals(c0017zzb.getFieldValue(field))) {
                                return false;
                            }
                        } else if (c0017zzb.isFieldSet(field)) {
                            return false;
                        }
                    }
                    return true;
        ...
        static {
            ...
            zzao.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C0017zzb.class));
            zzao.put(TtmlNode.TAG_LAYOUT, FastJsonResponse.Field.withConverter(TtmlNode.TAG_LAYOUT, 4, new StringToIntConverter().add("banner", 0), false));
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public zzb(Set<Integer> set, int i, zza zzaVar, C0017zzb c0017zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zzaVar;
            this.zzbq = c0017zzb;
    ...
    public static final class zze extends FastSafeParcelableJsonResponse implements Person.Organizations {
        ...
        static {
            ...
            zzao.put(FirebaseAnalytics.Param.LOCATION, FastJsonResponse.Field.forString(FirebaseAnalytics.Param.LOCATION, 5));
            ...
            zzao.put(ShareConstants.MEDIA_TYPE, FastJsonResponse.Field.withConverter(ShareConstants.MEDIA_TYPE, 10, new StringToIntConverter().add("work", 0).add("school", 1), false));
        }
    ...
    public static final class zzg extends FastSafeParcelableJsonResponse implements Person.Urls {
        ...
        static {
            ...
            zzao.put(ShareConstants.MEDIA_TYPE, FastJsonResponse.Field.withConverter(ShareConstants.MEDIA_TYPE, 6, new StringToIntConverter().add("home", 0).add("work", 1).add("blog", 2).add("profile", 3).add("other", 4).add("otherProfile", 5).add("contributor", 6).add("website", 7), false));
    ...
    static {
        ...
        zzao.put("objectType", FastJsonResponse.Field.withConverter("objectType", 21, new StringToIntConverter().add("person", 0).add(AuthorizationRequest.Display.PAGE, 1), false));
