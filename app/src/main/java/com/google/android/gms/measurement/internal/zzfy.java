...
public final class zzfy implements zzgt {
    ...
    zzfy(zzhb zzhbVar) {
        ...
        com.google.android.gms.internal.measurement.zzia.zze(this.zze);
        ...
        this.zzn.zzp(new zzfx(this, zzhbVar));
    }
    ...
    public final boolean zzM() {
        if (this.zzB) {
            ...
            if (bool == null || this.zzD == 0 || (!bool.booleanValue() && Math.abs(this.zzr.elapsedRealtime() - this.zzD) > 1000)) {
                ...
                boolean z = true;
                this.zzC = Boolean.valueOf(zzv().zzad("android.permission.INTERNET") && zzv().zzad("android.permission.ACCESS_NETWORK_STATE") && (Wrappers.packageManager(this.zze).isCallerInstantApp() || this.zzk.zzx() || (zzlh.zzaj(this.zze) && zzlh.zzak(this.zze, false))));
