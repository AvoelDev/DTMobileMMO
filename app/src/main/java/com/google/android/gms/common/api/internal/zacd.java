            ...
            if ((config == null || config.getMethodInvocationTelemetryEnabled()) && (zak = this.zaa.zak(this.zac)) != null && (zak.zaf() instanceof BaseGmsClient)) {
                ...
                if (config != null) {
                    ...
                    if (!baseGmsClient.hasConnectionInfo() || baseGmsClient.isConnecting()) {
                        ...
                        z = zab.getMethodTimingTelemetryEnabled() && this.zad > 0;
                        i2 = zab.getMaxMethodInvocationsLogged();
                        i3 = version;
                        i = batchPeriodMillis;
                    }
                } else {
                ...
                googleApiManager.zay(new MethodInvocation(this.zab, i4, errorCode, j, j2, null, null, gCoreServiceId, i5), i3, i, i2);
            }
        }
    }
}
