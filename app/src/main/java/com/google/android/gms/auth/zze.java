...
public final class zze {
    ...
    public static final Feature zzd = new Feature("account_data_service_token", 8);
    public static final Feature zze = new Feature("account_data_service_visibility", 1);
    public static final Feature zzf = new Feature("config_sync", 1);
    public static final Feature zzg = new Feature("device_account_api", 1);
    public static final Feature zzh = new Feature("gaiaid_primary_email_api", 1);
    ...
    public static final Feature zzk = new Feature("hub_mode_api", 1);
    public static final Feature zzl = new Feature("work_account_client_is_whitelisted", 1);
    public static final Feature[] zzm = {zza, zzb, zzc, zzd, zze, zzf, zzg, zzh, zzi, zzj, zzk, zzl};
}
