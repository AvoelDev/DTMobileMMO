...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    */
    public void moveToState(final android.support.v4.app.Fragment r12, int r13, int r14, int r15, boolean r16) {
        /*
    ...
    */
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        if (AuthorizationRequest.ResponseMode.FRAGMENT.equals(name)) {
