...
public final class MediaBrowserCompat {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class MediaBrowserServiceImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private final androidx.collection.ArrayMap<String, Subscription> mSubscriptions = new androidx.collection.ArrayMap<>();
        int mState = 1;
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallback.ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        MediaBrowserImplApi21(Context context, ComponentName componentName, ConnectionCallback connectionCallback, Bundle bundle) {
            ...
            this.mRootHints.putInt(androidx.media.MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 1);
        ...
        public void onConnected() {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(BundleCompat.getBinder(extras, androidx.media.MediaBrowserProtocol.EXTRA_SESSION_BINDER));
            if (asInterface != null) {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                if (i == 1) {
                    ...
                    Bundle bundle3 = data.getBundle(androidx.media.MediaBrowserProtocol.DATA_NOTIFY_CHILDREN_CHANGED_OPTIONS);
    ...
    public static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            BundleCompat.putBinder(bundle2, androidx.media.MediaBrowserProtocol.DATA_CALLBACK_TOKEN, iBinder);
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            ...
            BundleCompat.putBinder(bundle, androidx.media.MediaBrowserProtocol.DATA_CALLBACK_TOKEN, iBinder);
